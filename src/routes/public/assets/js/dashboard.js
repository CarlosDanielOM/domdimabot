...
let moduleCost = 50000;
let moduleCooldown = 0;
let moduleSkipQueue = false;
...
addVIPModule.addEventListener('click', async (e) => {
    ...
    let res = await fetch(`${baseUrl}/${channel}/create/reward`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
